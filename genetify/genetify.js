...
genetify.controls = {
    ...
    goal: function(){
        genetify.record.goal('random_1-100', Math.round(Math.random()*99) + 1);
        genetify.controls._refreshResults();
    },
    ...
    showResults: function(){
        ...
        genetify.controls._insertHTML('genetify_results_table', HTML);
    }
